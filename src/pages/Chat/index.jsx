...
const ClientChat = () => {
  ...
  // 👉 Khi mở khung chat, tự động cuộn xuống tin nhắn cuối
  useEffect(() => {
    if (isOpen) {
      setTimeout(() => {
          ...
          >
            ...
            <div className="bg-[#001F5D] text-white p-3 font-semibold text-[15px] flex items-center justify-between shadow-md">
              ...
              <button
                ...
                className="text-white/80 hover:text-white transition text-lg leading-none px-2"
                aria-label="Đóng"
              >
                ✕
              </button>
